...
public class Intents {
   ...
   * <ul>
   * <li>{@link #EXTRA_AMOUNT}, the transaction amount, a {@link Long}</li>
   * <li>{@link #EXTRA_CURRENCY}, the transaction currency, a {@link java.util.Currency}</li>
   * <li>{@link #EXTRA_TAX_AMOUNT}, the transaction's tax amount, a {@link Long}</li>
   ...
   * <li>{@link #EXTRA_SERVICE_CHARGE_AMOUNT}, the transactions' service charge amount, a {@link Long}</li>
   * <li>{@link #EXTRA_ORDER_ID}, the Clover order ID, a {@link String}</li>
   * <li>{@link #EXTRA_EMPLOYEE_ID}, the ID of the employee which initiated the payment, a {@link String}</li>
   ...
   * <ul>
   * <li>a (Required) {@link #EXTRA_AMOUNT}</li>, the approved transaction amount, a {@link Long}
   * <li>a (Optional) {@link #EXTRA_CLIENT_ID}, the client ID / external payment ID, a {@link String}</li>
   * <li>a (Optional) {@link #EXTRA_NOTE}, the payment note, a {@link String}</li>
   * </ul>
   *
   ...
   * <li>{@link #EXTRA_NOTE}, the order note for the transaction, a {@link String}
   * </ul>
   *
   * Result data must include the following,
   * <ul>
