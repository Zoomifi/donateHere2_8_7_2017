  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<Screenshot> {
    ...
    small {
      @Override
      public Object extractValue(Screenshot instance) {
        return instance.genClient.extractOther("small", String.class);
      }
    },
    medium {
      @Override
      public Object extractValue(Screenshot instance) {
        return instance.genClient.extractOther("medium", String.class);
      }
    },
    large {
      @Override
      public Object extractValue(Screenshot instance) {
        return instance.genClient.extractOther("large", String.class);
      }
    },
    ;
  }
