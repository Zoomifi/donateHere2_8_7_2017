...
public final class RolesContract {
  ...
  public interface PermissionSetsColumns {
    ...
    public static String ROLE_IDS = "(SELECT group_concat(" + Roles.CONTENT_DIRECTORY + "." + Roles.UUID + ",',') "
        + "FROM " + PermissionSetRoles.CONTENT_DIRECTORY + " "
        + "LEFT OUTER JOIN " + Roles.CONTENT_DIRECTORY + " "
        + "ON " + Roles.CONTENT_DIRECTORY + "." + Roles.UUID + "=" + PermissionSetRoles.CONTENT_DIRECTORY + "." + PermissionSetRoles.ROLE_ID + " "
        + "WHERE " + PermissionSets.CONTENT_DIRECTORY + "." + PermissionSets.UUID + "=" + PermissionSetRoles.CONTENT_DIRECTORY + "." + PermissionSetRoles.PERMISSION_SET_ID + ")";
    public static String ROLE_NAMES = "(SELECT group_concat(" + Roles.CONTENT_DIRECTORY + "." + Roles.NAME + ",',') "
        + "FROM " + PermissionSetRoles.CONTENT_DIRECTORY + " "
        + "LEFT OUTER JOIN " + Roles.CONTENT_DIRECTORY + " "
        + "ON " + Roles.CONTENT_DIRECTORY + "." + Roles.UUID + "=" + PermissionSetRoles.CONTENT_DIRECTORY + "." + PermissionSetRoles.ROLE_ID + " "
        + "WHERE " + PermissionSets.CONTENT_DIRECTORY + "." + PermissionSets.UUID + "=" + PermissionSetRoles.CONTENT_DIRECTORY + "." + PermissionSetRoles.PERMISSION_SET_ID + ")";
    public static String COUNTS_BY_APP = "(SELECT count(*) from " + PermissionSets.CONTENT_DIRECTORY + " AS inner "
