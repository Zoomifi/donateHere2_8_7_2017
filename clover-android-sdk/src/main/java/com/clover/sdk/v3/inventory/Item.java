  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<Item> {
    ...
    code {
      @Override
      public Object extractValue(Item instance) {
        return instance.genClient.extractOther("code", String.class);
      }
    },
    sku {
      @Override
      public Object extractValue(Item instance) {
        return instance.genClient.extractOther("sku", String.class);
      }
    },
    price {
      @Override
    ...
    defaultTaxRates {
      @Override
      public Object extractValue(Item instance) {
        return instance.genClient.extractOther("defaultTaxRates", Boolean.class);
      }
    },
    unitName {
      @Override
    ...
    cost {
      @Override
      public Object extractValue(Item instance) {
        return instance.genClient.extractOther("cost", Long.class);
      }
    },
    isRevenue {
      @Override
    ...
    stockCount {
      @Override
      public Object extractValue(Item instance) {
        return instance.genClient.extractOther("stockCount", Long.class);
      }
    },
    taxRates {
      @Override
