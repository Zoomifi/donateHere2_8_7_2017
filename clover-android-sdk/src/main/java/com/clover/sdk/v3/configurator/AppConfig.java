  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<AppConfig> {
    ...
    opportunityId {
      @Override
      public Object extractValue(AppConfig instance) {
        return instance.genClient.extractOther("opportunityId", String.class);
      }
    },
    mid {
      @Override
   ...
   */
  public AppConfig setOpportunityId(String opportunityId) {
   ...
   * Sets the field 'mid'.
   */
  public AppConfig setMid(String mid) {
