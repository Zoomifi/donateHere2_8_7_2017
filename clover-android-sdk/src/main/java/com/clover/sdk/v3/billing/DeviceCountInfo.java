  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<DeviceCountInfo> {
    totalDevices {
      ...
      public Object extractValue(DeviceCountInfo instance) {
        return instance.genClient.extractOther("totalDevices", Long.class);
      }
    },
    numStations {
      @Override
      public Object extractValue(DeviceCountInfo instance) {
        return instance.genClient.extractOther("numStations", Long.class);
      }
    },
    numMobiles {
      @Override
      public Object extractValue(DeviceCountInfo instance) {
        return instance.genClient.extractOther("numMobiles", Long.class);
      }
    },
    numMinis {
      @Override
      public Object extractValue(DeviceCountInfo instance) {
        return instance.genClient.extractOther("numMinis", Long.class);
      }
    },
    ;
  }
