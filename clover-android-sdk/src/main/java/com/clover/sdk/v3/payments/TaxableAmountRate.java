...
public final class TaxableAmountRate implements android.os.Parcelable, com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<TaxableAmountRate> {
    ...
    taxableAmount {
      @Override
      public Object extractValue(TaxableAmountRate instance) {
        return instance.genClient.extractOther("taxableAmount", Long.class);
      }
    },
    rate {
      @Override
      public Object extractValue(TaxableAmountRate instance) {
        return instance.genClient.extractOther("rate", Long.class);
      }
    },
    isVat {
      @Override
   ...
   * Sets the field 'id'.
   */
  public TaxableAmountRate setId(String id) {
   ...
   * Sets the field 'name'.
   */
  public TaxableAmountRate setName(String name) {
   ...
   * Sets the field 'rate'.
   */
  public TaxableAmountRate setRate(Long rate) {
   ...
   */
  public TaxableAmountRate setIsVat(Boolean isVat) {
