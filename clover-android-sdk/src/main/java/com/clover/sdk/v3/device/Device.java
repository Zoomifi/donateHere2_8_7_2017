  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<Device> {
    ...
    model {
      @Override
      public Object extractValue(Device instance) {
        return instance.genClient.extractOther("model", String.class);
      }
    },
    orderPrefix {
      @Override
      public Object extractValue(Device instance) {
        return instance.genClient.extractOther("orderPrefix", String.class);
      }
    },
    terminalPrefix {
      @Override
      public Object extractValue(Device instance) {
        return instance.genClient.extractOther("terminalPrefix", Integer.class);
      }
    },
    serial {
      @Override
      public Object extractValue(Device instance) {
        return instance.genClient.extractOther("serial", String.class);
      }
    },
    buildNumber {
      @Override
      public Object extractValue(Device instance) {
        return instance.genClient.extractOther("buildNumber", Long.class);
      }
    },
    secureId {
      @Override
      public Object extractValue(Device instance) {
        return instance.genClient.extractOther("secureId", String.class);
      }
    },
    buildType {
      @Override
    ...
    cpuId {
      @Override
      public Object extractValue(Device instance) {
        return instance.genClient.extractOther("cpuId", String.class);
      }
    },
    imei {
      @Override
      public Object extractValue(Device instance) {
        return instance.genClient.extractOther("imei", String.class);
      }
    },
    imsi {
      @Override
      public Object extractValue(Device instance) {
        return instance.genClient.extractOther("imsi", String.class);
      }
    },
    simIccid {
      @Override
      public Object extractValue(Device instance) {
        return instance.genClient.extractOther("simIccid", String.class);
      }
    },
    deviceCertificate {
      @Override
      public Object extractValue(Device instance) {
        return instance.genClient.extractOther("deviceCertificate", String.class);
      }
    },
    pedCertificate {
      @Override
      public Object extractValue(Device instance) {
        return instance.genClient.extractOther("pedCertificate", String.class);
      }
    },
    ;
  }
