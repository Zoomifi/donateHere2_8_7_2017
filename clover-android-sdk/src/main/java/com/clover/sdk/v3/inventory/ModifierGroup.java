  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<ModifierGroup> {
    ...
    minRequired {
      @Override
      public Object extractValue(ModifierGroup instance) {
        return instance.genClient.extractOther("minRequired", Integer.class);
      }
    },
    maxAllowed {
      @Override
      public Object extractValue(ModifierGroup instance) {
        return instance.genClient.extractOther("maxAllowed", Integer.class);
      }
    },
    showByDefault {
      @Override
      public Object extractValue(ModifierGroup instance) {
        return instance.genClient.extractOther("showByDefault", Boolean.class);
      }
    },
    modifiers {
      @Override
    ...
    modifierIds {
      @Override
      public Object extractValue(ModifierGroup instance) {
        return instance.genClient.extractOther("modifierIds", String.class);
      }
    },
    items {
      @Override
