  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<AndroidPermission> {
    ...
    permission {
      @Override
      public Object extractValue(AndroidPermission instance) {
        return instance.genClient.extractOther("permission", String.class);
      }
    },
    ;
  }
   ...
   * Sets the field 'id'.
   */
  public AndroidPermission setId(String id) {
   ...
   */
  public AndroidPermission setPermission(String permission) {
