  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<Printer> {
    ...
    mac {
      @Override
      public Object extractValue(Printer instance) {
        return instance.genClient.extractOther("mac", String.class);
      }
    },
    model {
      @Override
    ...
    ipAddress {
      @Override
      public Object extractValue(Printer instance) {
        return instance.genClient.extractOther("ipAddress", String.class);
      }
    },
    type {
      @Override
   ...
   * Sets the field 'mac'.
   */
  public Printer setMac(String mac) {
   ...
   */
  public Printer setIpAddress(String ipAddress) {
