  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<CountryInfo> {
    ...
    displayName {
      @Override
      public Object extractValue(CountryInfo instance) {
        return instance.genClient.extractOther("displayName", String.class);
      }
    },
    localDisplayName {
      @Override
      public Object extractValue(CountryInfo instance) {
        return instance.genClient.extractOther("localDisplayName", String.class);
      }
    },
    defaultCurrency {
      @Override
    ...
    defaultTimezone {
      @Override
      public Object extractValue(CountryInfo instance) {
        return instance.genClient.extractOther("defaultTimezone", String.class);
      }
    },
    stateProvinceRequired {
      @Override
      public Object extractValue(CountryInfo instance) {
        return instance.genClient.extractOther("stateProvinceRequired", Boolean.class);
      }
    },
    zipPostalRequired {
      @Override
      public Object extractValue(CountryInfo instance) {
        return instance.genClient.extractOther("zipPostalRequired", Boolean.class);
      }
    },
    countyRequired {
      @Override
      public Object extractValue(CountryInfo instance) {
        return instance.genClient.extractOther("countyRequired", Boolean.class);
      }
    },
    defaultLocale {
      @Override
      public Object extractValue(CountryInfo instance) {
        return instance.genClient.extractOther("defaultLocale", String.class);
      }
    },
    appMarketBillingEnabled {
      @Override
      public Object extractValue(CountryInfo instance) {
        return instance.genClient.extractOther("appMarketBillingEnabled", Boolean.class);
      }
    },
    ;
  }
