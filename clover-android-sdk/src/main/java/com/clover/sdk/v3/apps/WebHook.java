  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<WebHook> {
    ...
    secret {
      @Override
      public Object extractValue(WebHook instance) {
        return instance.genClient.extractOther("secret", String.class);
      }
    },
    valid {
      @Override
      public Object extractValue(WebHook instance) {
        return instance.genClient.extractOther("valid", Boolean.class);
      }
    },
    verification {
      @Override
      public Object extractValue(WebHook instance) {
        return instance.genClient.extractOther("verification", String.class);
      }
    },
    orders {
      @Override
      public Object extractValue(WebHook instance) {
        return instance.genClient.extractOther("orders", Boolean.class);
      }
    },
    app {
      @Override
      public Object extractValue(WebHook instance) {
        return instance.genClient.extractOther("app", Boolean.class);
      }
    },
    payments {
      @Override
      public Object extractValue(WebHook instance) {
        return instance.genClient.extractOther("payments", Boolean.class);
      }
    },
    inventory {
      @Override
      public Object extractValue(WebHook instance) {
        return instance.genClient.extractOther("inventory", Boolean.class);
      }
    },
    customers {
      @Override
      public Object extractValue(WebHook instance) {
        return instance.genClient.extractOther("customers", Boolean.class);
      }
    },
    merchants {
      @Override
      public Object extractValue(WebHook instance) {
        return instance.genClient.extractOther("merchants", Boolean.class);
      }
    },
    ;
  }
