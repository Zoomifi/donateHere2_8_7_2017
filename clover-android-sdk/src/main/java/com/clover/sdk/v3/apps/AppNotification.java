  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<AppNotification> {
    ...
    event {
      @Override
      public Object extractValue(AppNotification instance) {
        return instance.genClient.extractOther("event", String.class);
      }
    },
    timeToLive {
      @Override
      public Object extractValue(AppNotification instance) {
        return instance.genClient.extractOther("timeToLive", Long.class);
      }
    },
    data {
      @Override
      public Object extractValue(AppNotification instance) {
        return instance.genClient.extractOther("data", String.class);
      }
    },
    ;
  }
