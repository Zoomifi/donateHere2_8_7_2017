  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<PaymentRequest> {
    ...
    timestamp {
      @Override
      public Object extractValue(PaymentRequest instance) {
        return instance.genClient.extractOther("timestamp", Long.class);
      }
    },
    tender {
      @Override
    ...
    tipAmount {
      @Override
      public Object extractValue(PaymentRequest instance) {
        return instance.genClient.extractOther("tipAmount", Long.class);
      }
    },
    taxAmount {
      @Override
    ...
    cashBackAmount {
      @Override
      public Object extractValue(PaymentRequest instance) {
        return instance.genClient.extractOther("cashBackAmount", Long.class);
      }
    },
    cashTendered {
      @Override
      public Object extractValue(PaymentRequest instance) {
        return instance.genClient.extractOther("cashTendered", Long.class);
      }
    },
    employeeId {
      @Override
    ...
    employeeName {
      @Override
      public Object extractValue(PaymentRequest instance) {
        return instance.genClient.extractOther("employeeName", String.class);
      }
    },
    authorizationCode {
      @Override
      public Object extractValue(PaymentRequest instance) {
        return instance.genClient.extractOther("authorizationCode", String.class);
      }
    },
    externalPaymentId {
      @Override
      public Object extractValue(PaymentRequest instance) {
        return instance.genClient.extractOther("externalPaymentId", String.class);
      }
    },
    serviceChargeAmount {
      @Override
