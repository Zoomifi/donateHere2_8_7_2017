  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<Employee> {
    ...
    nickname {
      @Override
      public Object extractValue(Employee instance) {
        return instance.genClient.extractOther("nickname", String.class);
      }
    },
    customId {
      @Override
      public Object extractValue(Employee instance) {
        return instance.genClient.extractOther("customId", String.class);
      }
    },
    email {
      @Override
    ...
    inviteSent {
      @Override
      public Object extractValue(Employee instance) {
        return instance.genClient.extractOther("inviteSent", Boolean.class);
      }
    },
    claimedTime {
      @Override
      public Object extractValue(Employee instance) {
        return instance.genClient.extractOther("claimedTime", Long.class);
      }
    },
    pin {
      @Override
      public Object extractValue(Employee instance) {
        return instance.genClient.extractOther("pin", String.class);
      }
    },
    unhashedPin {
      @Override
      public Object extractValue(Employee instance) {
        return instance.genClient.extractOther("unhashedPin", String.class);
      }
    },
    role {
      @Override
    ...
    isOwner {
      @Override
      public Object extractValue(Employee instance) {
        return instance.genClient.extractOther("isOwner", Boolean.class);
      }
    },
    shifts {
      @Override
