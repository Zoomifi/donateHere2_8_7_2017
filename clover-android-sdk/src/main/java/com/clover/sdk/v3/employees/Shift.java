  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<Shift> {
    ...
    cashTipsCollected {
      @Override
      public Object extractValue(Shift instance) {
        return instance.genClient.extractOther("cashTipsCollected", Long.class);
      }
    },
    serverBanking {
      @Override
      public Object extractValue(Shift instance) {
        return instance.genClient.extractOther("serverBanking", Boolean.class);
      }
    },
    inTime {
      @Override
      public Object extractValue(Shift instance) {
        return instance.genClient.extractOther("inTime", Long.class);
      }
    },
    overrideInTime {
      @Override
      public Object extractValue(Shift instance) {
        return instance.genClient.extractOther("overrideInTime", Long.class);
      }
    },
    overrideInEmployee {
      @Override
    ...
    outTime {
      @Override
      public Object extractValue(Shift instance) {
        return instance.genClient.extractOther("outTime", Long.class);
      }
    },
    overrideOutTime {
      @Override
      public Object extractValue(Shift instance) {
        return instance.genClient.extractOther("overrideOutTime", Long.class);
      }
    },
    overrideOutEmployee {
      @Override
