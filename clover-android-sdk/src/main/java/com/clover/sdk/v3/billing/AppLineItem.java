...
public final class AppLineItem implements android.os.Parcelable, com.clover.sdk.v3.Validator, com.clover.sdk.JSONifiable {
  ...
  */
   ...
   */
  public AppLineItem(String json) throws IllegalArgumentException {
    try {
  ...
  public void validate() {
    ...
    if (app == null) throw new IllegalArgumentException("'app' is required to be non-null");

    com.clover.sdk.v3.base.Reference merchant = getMerchant();
    if (merchant == null) throw new IllegalArgumentException("'merchant' is required to be non-null");

    Long amount = getAmount();
    if (amount == null) throw new IllegalArgumentException("'amount' is required to be non-null");

    com.clover.sdk.v3.billing.AppLineItemStatus status = getStatus();
    if (status == null) throw new IllegalArgumentException("'status' is required to be non-null");

    com.clover.sdk.v3.billing.AppLineItemType type = getType();
    if (type == null) throw new IllegalArgumentException("'type' is required to be non-null");
  }
   ...
   * Sets the field 'id'.
   */
  public AppLineItem setId(String id) {
    logChange("id");
   ...
   */
  public AppLineItem setAmount(Long amount) {
    logChange("amount");
   ...
   */
  public AppLineItem setCreatedTime(Long createdTime) {
   ...
   */
  public AppLineItem setModifiedTime(Long modifiedTime) {
   ...
   */
  public AppLineItem setAppUninstallTime(Long appUninstallTime) {
