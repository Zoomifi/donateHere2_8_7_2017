  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<AppBillingInfo> {
    ...
    isInTrial {
      @Override
      public Object extractValue(AppBillingInfo instance) {
        return instance.genClient.extractOther("isInTrial", Boolean.class);
      }
    },
    billingStartTime {
      @Override
    ...
    daysLapsed {
      @Override
      public Object extractValue(AppBillingInfo instance) {
        return instance.genClient.extractOther("daysLapsed", Long.class);
      }
    },
    ;
  }
   ...
   */
  public AppBillingInfo setIsInTrial(Boolean isInTrial) {
