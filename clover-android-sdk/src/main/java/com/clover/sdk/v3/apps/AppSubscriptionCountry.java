  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<AppSubscriptionCountry> {
    ...
    active {
      @Override
      public Object extractValue(AppSubscriptionCountry instance) {
        return instance.genClient.extractOther("active", Boolean.class);
      }
    },
    appSubscription {
      @Override
    ...
    installCountBillable {
      @Override
      public Object extractValue(AppSubscriptionCountry instance) {
        return instance.genClient.extractOther("installCountBillable", Long.class);
      }
    },
    ;
  }
   ...
   */
  public AppSubscriptionCountry setInstallCountBillable(Long installCountBillable) {
