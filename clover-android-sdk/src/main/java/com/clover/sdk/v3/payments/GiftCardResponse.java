  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<GiftCardResponse> {
    ...
    requestAmount {
      @Override
      public Object extractValue(GiftCardResponse instance) {
        return instance.genClient.extractOther("requestAmount", Long.class);
      }
    },
    payment {
      @Override
    ...
    responseMessage {
      @Override
      public Object extractValue(GiftCardResponse instance) {
        return instance.genClient.extractOther("responseMessage", String.class);
      }
    },
    requestSuccessful {
      @Override
      public Object extractValue(GiftCardResponse instance) {
        return instance.genClient.extractOther("requestSuccessful", Boolean.class);
      }
    },
    accountNumber {
      @Override
      public Object extractValue(GiftCardResponse instance) {
        return instance.genClient.extractOther("accountNumber", String.class);
      }
    },
    giftCardTxUuid {
      @Override
      public Object extractValue(GiftCardResponse instance) {
        return instance.genClient.extractOther("giftCardTxUuid", String.class);
      }
    },
    transactionId {
      @Override
      public Object extractValue(GiftCardResponse instance) {
        return instance.genClient.extractOther("transactionId", String.class);
      }
    },
    referenceUuid {
      @Override
      public Object extractValue(GiftCardResponse instance) {
        return instance.genClient.extractOther("referenceUuid", String.class);
      }
    },
    authCode {
      @Override
    ...
    begBal {
      @Override
      public Object extractValue(GiftCardResponse instance) {
        return instance.genClient.extractOther("begBal", Long.class);
      }
    },
    endBal {
      @Override
      public Object extractValue(GiftCardResponse instance) {
        return instance.genClient.extractOther("endBal", Long.class);
      }
    },
    holdBal {
      @Override
      public Object extractValue(GiftCardResponse instance) {
        return instance.genClient.extractOther("holdBal", Long.class);
      }
    },
    ;
  }
