  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<AndroidVersion> {
    ...
    createdAt {
      @Override
      public Object extractValue(AndroidVersion instance) {
        return instance.genClient.extractOther("createdAt", Long.class);
      }
    },
    version {
      @Override
      public Object extractValue(AndroidVersion instance) {
        return instance.genClient.extractOther("version", Long.class);
      }
    },
    versionName {
      @Override
      public Object extractValue(AndroidVersion instance) {
        return instance.genClient.extractOther("versionName", String.class);
      }
    },
    approved {
      @Override
    ...
    hash {
      @Override
      public Object extractValue(AndroidVersion instance) {
        return instance.genClient.extractOther("hash", String.class);
      }
    },
    deviceInstallCount {
      @Override
      public Object extractValue(AndroidVersion instance) {
        return instance.genClient.extractOther("deviceInstallCount", Long.class);
      }
    },
    hashOriginal {
      @Override
      public Object extractValue(AndroidVersion instance) {
        return instance.genClient.extractOther("hashOriginal", String.class);
      }
    },
    approvalStatus {
      @Override
    ...
    scanId {
      @Override
      public Object extractValue(AndroidVersion instance) {
        return instance.genClient.extractOther("scanId", String.class);
      }
    },
    minSdkVersion {
      @Override
      public Object extractValue(AndroidVersion instance) {
        return instance.genClient.extractOther("minSdkVersion", Long.class);
      }
    },
    sigAlg {
      @Override
      public Object extractValue(AndroidVersion instance) {
        return instance.genClient.extractOther("sigAlg", String.class);
      }
    },
    apkUrl {
      @Override
      public Object extractValue(AndroidVersion instance) {
        return instance.genClient.extractOther("apkUrl", String.class);
      }
    },
    permissions {
      @Override
      public Object extractValue(AndroidVersion instance) {
        return instance.genClient.extractListOther("permissions", String.class);
      }
    },
    app {
      @Override
   ...
   */
  public AndroidVersion setApproved(Boolean approved) {
   ...
   * Sets the field 'hash'.
   */
  public AndroidVersion setHash(String hash) {
   ...
   */
  public AndroidVersion setScanId(String scanId) {
   ...
   */
  public AndroidVersion setSigAlg(String sigAlg) {
   ...
   */
  public AndroidVersion setPermissions(java.util.List<String> permissions) {
