  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<Tender> {
    ...
    editable {
      @Override
      public Object extractValue(Tender instance) {
        return instance.genClient.extractOther("editable", Boolean.class);
      }
    },
    labelKey {
      @Override
    ...
    opensCashDrawer {
      @Override
      public Object extractValue(Tender instance) {
        return instance.genClient.extractOther("opensCashDrawer", Boolean.class);
      }
    },
    supportsTipping {
      @Override
    ...
    enabled {
      @Override
      public Object extractValue(Tender instance) {
        return instance.genClient.extractOther("enabled", Boolean.class);
      }
    },
    visible {
      @Override
      public Object extractValue(Tender instance) {
        return instance.genClient.extractOther("visible", Boolean.class);
      }
    },
    instructions {
      @Override
      public Object extractValue(Tender instance) {
        return instance.genClient.extractOther("instructions", String.class);
      }
    },
    ;
  }
