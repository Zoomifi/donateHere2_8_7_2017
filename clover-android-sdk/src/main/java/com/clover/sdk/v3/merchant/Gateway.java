  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<Gateway> {
    paymentProcessorName {
      ...
      public Object extractValue(Gateway instance) {
        return instance.genClient.extractOther("paymentProcessorName", String.class);
      }
    },
    paymentGatewayApi {
      @Override
      public Object extractValue(Gateway instance) {
        return instance.genClient.extractOther("paymentGatewayApi", String.class);
      }
    },
    accountName {
      @Override
      public Object extractValue(Gateway instance) {
        return instance.genClient.extractOther("accountName", String.class);
      }
    },
    mid {
      @Override
    ...
    tid {
      @Override
      public Object extractValue(Gateway instance) {
        return instance.genClient.extractOther("tid", String.class);
      }
    },
    storeId {
      @Override
      public Object extractValue(Gateway instance) {
        return instance.genClient.extractOther("storeId", String.class);
      }
    },
    supportsTipping {
      @Override
      public Object extractValue(Gateway instance) {
        return instance.genClient.extractOther("supportsTipping", Boolean.class);
      }
    },
    backendMid {
      @Override
      public Object extractValue(Gateway instance) {
        return instance.genClient.extractOther("backendMid", String.class);
      }
    },
    supportsTipAdjust {
      @Override
      public Object extractValue(Gateway instance) {
        return instance.genClient.extractOther("supportsTipAdjust", Boolean.class);
      }
    },
    supportsNakedCredit {
      @Override
      public Object extractValue(Gateway instance) {
        return instance.genClient.extractOther("supportsNakedCredit", Boolean.class);
      }
    },
    closingTime {
      @Override
      public Object extractValue(Gateway instance) {
        return instance.genClient.extractOther("closingTime", String.class);
      }
    },
    newBatchCloseEnabled {
      @Override
      public Object extractValue(Gateway instance) {
        return instance.genClient.extractOther("newBatchCloseEnabled", Boolean.class);
      }
    },
    ;
  }
