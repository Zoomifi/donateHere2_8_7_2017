  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<OrderType> {
    ...
    labelKey {
      @Override
      public Object extractValue(OrderType instance) {
        return instance.genClient.extractOther("labelKey", String.class);
      }
    },
    label {
      @Override
      public Object extractValue(OrderType instance) {
        return instance.genClient.extractOther("label", String.class);
      }
    },
    taxable {
      @Override
      public Object extractValue(OrderType instance) {
        return instance.genClient.extractOther("taxable", Boolean.class);
      }
    },
    isDefault {
      @Override
      public Object extractValue(OrderType instance) {
        return instance.genClient.extractOther("isDefault", Boolean.class);
      }
    },
    filterCategories {
      @Override
      public Object extractValue(OrderType instance) {
        return instance.genClient.extractOther("filterCategories", Boolean.class);
      }
    },
    isHidden {
      @Override
      public Object extractValue(OrderType instance) {
        return instance.genClient.extractOther("isHidden", Boolean.class);
      }
    },
    fee {
      @Override
      public Object extractValue(OrderType instance) {
        return instance.genClient.extractOther("fee", Long.class);
      }
    },
    minOrderAmount {
      @Override
      public Object extractValue(OrderType instance) {
        return instance.genClient.extractOther("minOrderAmount", Long.class);
      }
    },
    maxOrderAmount {
      @Override
      public Object extractValue(OrderType instance) {
        return instance.genClient.extractOther("maxOrderAmount", Long.class);
      }
    },
    maxRadius {
      @Override
      public Object extractValue(OrderType instance) {
        return instance.genClient.extractOther("maxRadius", Long.class);
      }
    },
    avgOrderTime {
      @Override
      public Object extractValue(OrderType instance) {
        return instance.genClient.extractOther("avgOrderTime", Long.class);
      }
    },
    hoursAvailable {
      @Override
    ...
    isDeleted {
      @Override
      public Object extractValue(OrderType instance) {
        return instance.genClient.extractOther("isDeleted", Boolean.class);
      }
    },
    systemOrderTypeId {
      @Override
      public Object extractValue(OrderType instance) {
        return instance.genClient.extractOther("systemOrderTypeId", String.class);
      }
    },
    hours {
      @Override
