  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<LineItem> {
    ...
    unitQty {
      @Override
      public Object extractValue(LineItem instance) {
        return instance.genClient.extractOther("unitQty", Integer.class);
      }
    },
    unitName {
      @Override
      public Object extractValue(LineItem instance) {
        return instance.genClient.extractOther("unitName", String.class);
      }
    },
    itemCode {
      @Override
      public Object extractValue(LineItem instance) {
        return instance.genClient.extractOther("itemCode", String.class);
      }
    },
    note {
      @Override
      public Object extractValue(LineItem instance) {
        return instance.genClient.extractOther("note", String.class);
      }
    },
    printed {
      @Override
      public Object extractValue(LineItem instance) {
        return instance.genClient.extractOther("printed", Boolean.class);
      }
    },
    exchangedLineItem {
      @Override
    ...
    binName {
      @Override
      public Object extractValue(LineItem instance) {
        return instance.genClient.extractOther("binName", String.class);
      }
    },
    userData {
      @Override
      public Object extractValue(LineItem instance) {
        return instance.genClient.extractOther("userData", String.class);
      }
    },
    createdTime {
      @Override
    ...
    orderClientCreatedTime {
      @Override
      public Object extractValue(LineItem instance) {
        return instance.genClient.extractOther("orderClientCreatedTime", Long.class);
      }
    },
    discounts {
      @Override
    ...
    discountAmount {
      @Override
      public Object extractValue(LineItem instance) {
        return instance.genClient.extractOther("discountAmount", Long.class);
      }
    },
    exchanged {
      @Override
      public Object extractValue(LineItem instance) {
        return instance.genClient.extractOther("exchanged", Boolean.class);
      }
    },
    modifications {
      @Override
    ...
    refunded {
      @Override
      public Object extractValue(LineItem instance) {
        return instance.genClient.extractOther("refunded", Boolean.class);
      }
    },
    isRevenue {
      @Override
      public Object extractValue(LineItem instance) {
        return instance.genClient.extractOther("isRevenue", Boolean.class);
      }
    },
    taxRates {
      @Override
