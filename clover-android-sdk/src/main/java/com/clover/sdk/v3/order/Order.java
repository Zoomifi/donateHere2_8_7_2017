  ...
  */
  ...
  private enum CacheKey implements com.clover.sdk.ValueExtractorEnum<Order> {
    ...
    currency {
      @Override
      public Object extractValue(Order instance) {
        return instance.genClient.extractOther("currency", String.class);
      }
    },
    customers {
      @Override
    ...
    title {
      @Override
      public Object extractValue(Order instance) {
        return instance.genClient.extractOther("title", String.class);
      }
    },
    note {
      @Override
    ...
    taxRemoved {
      @Override
      public Object extractValue(Order instance) {
        return instance.genClient.extractOther("taxRemoved", Boolean.class);
      }
    },
    isVat {
      @Override
      public Object extractValue(Order instance) {
        return instance.genClient.extractOther("isVat", Boolean.class);
      }
    },
    state {
      @Override
    ...
    manualTransaction {
      @Override
      public Object extractValue(Order instance) {
        return instance.genClient.extractOther("manualTransaction", Boolean.class);
      }
    },
    groupLineItems {
      @Override
    ...
    testMode {
      @Override
      public Object extractValue(Order instance) {
        return instance.genClient.extractOther("testMode", Boolean.class);
      }
    },
    payType {
      @Override
