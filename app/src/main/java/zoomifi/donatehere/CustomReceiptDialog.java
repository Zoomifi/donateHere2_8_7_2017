...
import zoomifi.donatehere.Utilities.apiHelper;
...
public class CustomReceiptDialog extends Dialog
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        emailButton = (TextView) findViewById(R.id.emailreceipt);
        ...
        textButton = (TextView) findViewById(R.id.textreceipt);
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        public void run() {
                            ...
                            if(e.getMessage() != null)
                                Toast.makeText(context, "Receipt Failure 0x01: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            else
                                Toast.makeText(context, "Receipt Failure 0x02: Null Error Message.", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                ...
                public void onResponse(okhttp3.Call call, Response response) throws IOException {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        new Handler(Looper.getMainLooper()).post(new Runnable() {
                            ...
                            public void run() {
                                // do stuff on ui thread
                                Toast.makeText(context, "Receipt Failure 0x03: " + responseStr, Toast.LENGTH_SHORT).show();
